...
available_setting = {
    ...
    "model": "gpt-5.6-luna",  # 可选择: gpt-5.6-luna, gpt-5.6-sol, gpt-5.6-terra, gpt-4o, gpt-4o-mini, gpt-4-turbo, claude-3-sonnet, wenxin, moonshot, qwen-turbo, xunfei, glm-4, minimax, gemini等模型，全部可选模型详见common/const.py文件
