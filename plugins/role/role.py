...
class Role(Plugin):
    ...
    def on_handle_context(self, e_context: EventContext):
        ...
        if btype not in [const.OPEN_AI, const.CHATGPTONAZURE, const.QWEN_DASHSCOPE, const.XUNFEI, const.BAIDU, const.ZHIPU_AI, const.MOONSHOT, const.MiniMax, const.LINKAI]:
